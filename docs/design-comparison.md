...
| Consent extras | No Instagram fallback, no "didn't open" message | "Messages didn't open?" fallback text after 1.2s, plus a "DM @dukedrop_ on Instagram instead" link |
